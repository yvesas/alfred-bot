...
describe("AccountService", () => {
  ...
  let proactiveLogRepo: sinon.SinonStubbedInstance<ProactiveLogRepository>;
  ...
  beforeEach(() => {
    ...
    proactiveLogRepo = sinon.createStubInstance(ProactiveLogRepository);
    proactiveLogRepo.deleteByUser.resolves(0);
