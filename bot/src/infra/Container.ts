...
container.bind<QrService>(QrService).toSelf();
...
container.bind<ProactiveLogRepository>(ProactiveLogRepository).toSelf();
container.bind<ProactiveService>(ProactiveService).toSelf();
container.bind<ProactiveScheduler>(ProactiveScheduler).toSelf().inSingletonScope();
